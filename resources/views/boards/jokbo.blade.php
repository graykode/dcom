...
<div class="col-md-8 col-md-offset-2">
	<div class="panel panel-default">
		<div class="panel-heading">과제/족보/솔루션</div>
		<div class="panel-body">
		
			<div class="form-group">
				<div class="col-md-12">
					<a href="/jokbo/write" class="btn btn-success" role="button">과목추가</a>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-md-12">
					@foreach ($boards->reverse() as $board)
						<a href="/jokbo/{{$board->id}}" style="text-decoration: none;">
							<div class="panel panel-success group-list" style="height:86px;">
	...
	<div class="panel panel-default">
		...
		<div style="margin: 20px 0; width: 100%;">
			...
			<div style="float:right; margin: 0 10px;">
				<button type="submit" class="btn btn-success" onclick="search('jokbo')">검색</button>
			</div>
